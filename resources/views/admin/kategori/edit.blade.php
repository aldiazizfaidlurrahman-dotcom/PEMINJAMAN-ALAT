...
<div class="content-wrapper">
    ...
    <div style="margin-bottom: 1.5rem; font-size: 0.875rem; color: #64748b; display: flex; align-items: center; gap: 8px;">
        ...
        <span>Kategori</span>
        <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
        <span style="color: #1e293b; font-weight: 600;">Edit Kategori</span>
    </div>

    <div class="form-card">
        <div class="form-header">
            <h3>Edit Kategori</h3>
            <p>Ubah nama kategori untuk memperbarui pengelompokan inventaris.</p>
        </div>
        ...
        <form action="{{ route('admin.kategori.update', $kategori->id) }}" method="POST" id="editKategoriForm">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nama_kategori" name="nama_kategori" class="form-control" placeholder="Masukkan nama kategori" value="{{ old('nama_kategori', $kategori->nama_kategori) }}" required autofocus>
                @error('nama_kategori') 
...
<script>
    // Loading Feedback
    document.getElementById('editKategoriForm').onsubmit = function() {
